...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Run simple MCQA experiments with optional flags.")
    ...
    parser.add_argument("--results_dir", type=str, default="simple_MCQA_results", help="Directory to save results")
    parser.add_argument("--model_dir", type=str, default="simple_MCQA_models", help="Directory to save trained models")
    ...
    if not args.skip_qwen:
        models.append("Qwen/Qwen2.5-0.5B")
    ...
    for model_name in models:
        ...
        if not args.skip_answer:
            ...
            # Prepare train and test data dictionaries (again, in case filtered_datasets changed)
            train_data = {}
            test_data = {}
